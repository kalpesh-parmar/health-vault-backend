...
CREATE TYPE "public"."file_type" AS ENUM('application/document', 'image/jpeg', 'application/pdf', 'image/png', 'image/tiff', 'text/plain', 'image/webp', 'image/jpg');--> statement-breakpoint
