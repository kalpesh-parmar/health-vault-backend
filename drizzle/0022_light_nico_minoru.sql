...
ALTER TYPE "public"."file_type" ADD VALUE 'image/tiff' BEFORE 'text/plain';--> statement-breakpoint
ALTER TYPE "public"."file_type" ADD VALUE 'image/webp' BEFORE 'image/jpg';--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "patients" ADD COLUMN "blood_group" varchar(8);--> statement-breakpoint
...
CREATE INDEX "document_processing_jobs_expires_at_idx" ON "document_processing_jobs" USING btree ("expires_at");