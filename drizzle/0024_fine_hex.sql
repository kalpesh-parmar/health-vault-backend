...
ALTER TABLE "medication_reminder_occurrences" DROP COLUMN "after_notification_sent";--> statement-breakpoint
ALTER TABLE "medication_reminder_occurrences" DROP COLUMN "after_notification_sent_at";--> statement-breakpoint
ALTER TABLE "medication_reminder_occurrences" DROP COLUMN "refill_reminder_time";--> statement-breakpoint
ALTER TABLE "medication_reminder_occurrences" DROP COLUMN "overdue_notification_sent";--> statement-breakpoint
ALTER TABLE "medication_reminder_occurrences" DROP COLUMN "overdue_notification_sent_at";