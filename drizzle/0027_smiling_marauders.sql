...
CREATE TYPE "public"."document_type" AS ENUM('PRESCRIPTION', 'LAB_REPORT', 'IMAGING_REPORT', 'DISCHARGE_SUMMARY', 'CONSULTATION_REPORT', 'SURGERY_PROCEDURE_REPORT', 'VACCINATION_RECORD', 'MEDICAL_CERTIFICATE', 'OTHER_MEDICAL_DOCUMENT');--> statement-breakpoint
