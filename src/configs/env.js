...
const env = Object.freeze({
  ...
  patientDocumentsBucket: stringFromEnv("PATIENT_DOCUMENTS_BUCKET") || "patient-documents",
  ...
  smtpUser: stringFromEnv("SMTP_USER"),
  storageProvider: resolveStorageProvider(),
  userProfileImagesBucket: stringFromEnv("USER_PROFILE_IMAGES_BUCKET") || "user-profile-images",
});
