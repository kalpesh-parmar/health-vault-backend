...
const errorConstants = Object.freeze({
  ...
  END_DATE_NULL: "End date must be null if medication is ongoing",
  ONE_REQUIRED: "At least one time required",
  FREQUENCY_REQUIRED: "Frequency required",
  INVALID_TYPE: "Invalid medication type",
  MEDICATION_TYPE_REQUIRED: "Medication type required",
